...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath %>/assets2/js/progress-bar/number-pb.css">
...
<body> 
    ...
    <script type="text/javascript" src="<%=basePath %>/assets2/js/jquery.js"></script>
    <script <%=basePath %>/src="assets2/js/progress-bar/src/jquery.velocity.min.js"></script>
    <script <%=basePath %>/src="assets2/js/progress-bar/number-pb.js"></script>
    <script <%=basePath %>/src="assets2/js/progress-bar/progress-app.js"></script>
    ...
    <script type="text/javascript" src="assets2/js/chart/jquery.flot.js"></script>
    <script type="text/javascript" src="assets2/js/chart/jquery.flot.resize.js"></script>
    <script type="text/javascript" src="assets2/js/chart/realTime.js"></script>
    <script type="text/javascript" src="assets2/js/speed/canvasgauge-coustom.js"></script>
    <script type="text/javascript" src="assets2/js/countdown/jquery.countdown.js"></script>



    <script src="<%=basePath %>/assets2/js/jhere-custom.js"></script>
