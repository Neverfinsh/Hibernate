            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <!-- 提交的 方式 -->
                        ...
                        <form  action="<%=basePath%>/friend/addship.do" method="post">
                            ...
                            <label for="inputUsernameEmail">是否添加好友</label></br>
                                                                           好友 <input type="radio" id="inputUsernameEmail"  name="shipStatus" value="1">
